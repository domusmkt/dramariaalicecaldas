...
const CtaDetailSection: React.FC = () => {
  return (
    <section className="py-16 sm:py-24 bg-white dark:bg-gray-950 text-center">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
        <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white mb-10 font-serif">
          Cuidar da saúde do seu filho é o melhor investimento para o futuro.
        </h2>
...
export default CtaDetailSection;